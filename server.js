...
app.get('/pipedrive/pipelines/:id/deals/all', async (req, res) => {
  try {
    ...
    while (true) {
      ...
      start += 500;
      if (page > 50) break; // seguridad: máximo 25.000 deals por pipeline
    }

    console.log(`[Pipeline ${id}] Total cargados: ${all.length}`);
...
// Ruta general — reenvía cualquier llamada a Pipedrive
